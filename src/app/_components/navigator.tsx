        ...
        <div>
          <a href="/">
            <Image
              src={vetMaisLogo}
              alt="Logo Vet Mais"
              className="h-20 w-32 ml-20 rounded-full"
            />
          </a>
        </div>
        <div className="flex items-center ml-8 md:mr-28">
          <ul className="flex gap-5 pr-5 invisible md:visible">
            <li className="text-xl  px-4 py-1  hover:text-green-700">
          ...
          <div className="">
            <a
              ...
              target="_blank"
              className="bg-[#3de85a] text white flex items-center justify-center w-22 gap-2 px-4 py-2 rounded-md invisible md:visible"
            >
